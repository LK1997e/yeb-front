  ...
  <div id="list">
    <ul style="padding-left: 0;">
      <li v-for="item in admins" :class="{ active: currentSession?item.username === currentSession.username:false }"
        ...
        <el-badge :is-dot="idDot[user.username+'#'+item.username]"><img class="avatar" :src="item.userFace" :alt="item.name"></el-badge>
...
export default {
  ...
  methods: {
    changecurrentSession: function (currentSession) {
      console.log('sdg=>'+JSON.stringify(currentSession));
